...
//  if(trigger.isBefore){
//    for (Account newAcc : trigger.new) {
//       if(trigger.newInsert&& newAcc.active__c== 'yes'){
//          //update desc field
//          //set new field value
//          newAcc.Description= 'Account is now active.';
//       }
//       //check if update
//       if(trigger.isUpdate){
//          //if  active field changed, and active new value is 'yes'
//          // old acc active field!= new acc active field and new acc active field== yes
...
//     }
// }
// list<Account> newListAcc = [SELECT Id,name,rating from Account where Id In:AccIds];
...
/* soru 2: When the Annual revenue value of an Account is reduced from the previous value then print the
following message:
